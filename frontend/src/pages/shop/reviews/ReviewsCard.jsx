    ...
    <div className='my-6 bg-white p-8'>
        <div>
            {
                reviews.length > 0 ? ( <div>
                    <h3 className='text-lg-front-medium'>All comments.....</h3>
                    <div>
                        {
                                ...
                                <div key={index} className='mt-4'>
                                    ...
                                    <div className='flex gap-4 items-center'>
                                        ...
                                        <div className='space-y-1'>
                                            ...
                                            <p className='text-[12px] italic'>{(review?.updatedAt)}</p>
        ...
        <div className='mt-12'> 
            <button 
                ...
                className='px-6 py-3 bg-primary text-white rounded-md'>Add a review
            </button>
        </div>
